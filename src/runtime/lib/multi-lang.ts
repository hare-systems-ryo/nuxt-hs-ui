...
/* ----------------------------------------------------------------------------
// [ com > lib > * ]
import type { MultiLang } from '@/com/lib/multi-lang';
import { JoinMultiLang } from '@/com/lib/multi-lang';
import { GetTextByMultiLang } from '@/com/lib/multi-lang';
----------------------------------------------------------------------------- */
...
export const GetTextByMultiLang = (text: MultiLang, lang: string | undefined, fallback: string | undefined = 'ja') => {
