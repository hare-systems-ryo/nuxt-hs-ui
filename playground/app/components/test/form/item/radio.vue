      ...
      <div class="grid grid-cols-1 gap-2">
        ...
        <!--  ------------------------------------------------
          ...
          <div class="flex gap-1" @click="state.testNumber.data = null">
            <div class="">
              state.testNumber.data:{{ state.testNumber.data === null ? 'null' : state.testNumber.data }}
            </div>
            <div class="border border-accent1 text-accent1 bg-white px-2 rounded" @click="state.testNumber.data = null">
              reset
            </div>
          </div>
        </div>
