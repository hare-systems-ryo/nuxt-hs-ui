...
/* ----------------------------------------------------------------------------
// playground\components\test\form\index.vue
// ----------------------------------------------------------------------------
// TestForm
// TestFormTestForm
----------------------------------------------------------------------------- */
  ...
  <div class="">
    ...
    <div class="">
      ...
      <TestFormItemCheckBox
        v-if="item === '' || item === 'CheckBox'"
        class="mt-5"
      />
      <TestFormItemCheckList
        v-if="item === '' || item === 'CheckList'"
        class="mt-5"
      />
      <TestFormItemDatepicker
        v-if="item === '' || item === 'Datepicker'"
        class="mt-5"
      />
      <TestFormItemInputFrame
        v-if="item === '' || item === 'InputFrame'"
        class="mt-5"
      />
      <TestFormItemRadio v-if="item === '' || item === 'Radio'" class="mt-5" />
      <TestFormItemSelect
        v-if="item === '' || item === 'Select'"
        class="mt-5"
      />
      <TestFormItemTextBox
        v-if="item === '' || item === 'TextBox'"
        class="mt-5"
      />
      <TestFormItemTextarea
        v-if="item === '' || item === 'Textarea'"
        class="mt-5"
      />
      <TestFormItemValueBox
        v-if="item === '' || item === 'ValueBox'"
        class="mt-5"
      />
    </div>
  </div>
