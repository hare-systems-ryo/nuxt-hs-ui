...
/* ----------------------------------------------------------------------------
// playground\components\test\form\item\btn.vue
// ----------------------------------------------------------------------------
// TestFormItemBtn
    ...
    <CardItem class="" variant="body">
      ...
      <div class="">
        ...
        <div class="flex gap-2">
          ...
          <div class="flex-none h-[44px] w-10 bg-red-500 text-white flex-cc">
            44px
          </div>
        </div>
        <div class="h-[4px] bg-green-500"></div>
      ...
      <div class="py-2"></div>
      <div class="">flat</div>
      <div class="grid grid-cols-4 800:grid-cols-8 gap-1">
        <template v-for="(color, index) in ThemeList" :key="index">
          <Btn
            :theme="color"
            variant="flat"
            :disabled="disabled"
