...
/* ----------------------------------------------------------------------------
// playground\components\test\form\item\check-list.vue
// ----------------------------------------------------------------------------
// TestFormItemCheckList
// TestFormItemCheckListTestFormItemCheckList
----------------------------------------------------------------------------- */
...
<template>
  <Card class="mt-4">
    <CardItem class="" variant="header"> CheckList </CardItem>
