  ...
  <Card class="">
    ...
    <CardItem variant="body">
      <div class="flex gap-2">
        <Btn theme="link" variant="outlined" @click="modal.testA.show()">
          Modal1
        </Btn>
        <Btn theme="link" variant="outlined" @click="modal.testB.show()">
          Modal2
        </Btn>
      </div>
