...
/* ----------------------------------------------------------------------------
// playground\components\test\interactive\index.vue
// ----------------------------------------------------------------------------
// TestInteractive
  ...
  <div class="">
    ...
    <div class="">
      <TestInteractiveItemAlert
        v-if="item === '' || item === 'Alert'"
        class="mt-5"
      />
      <TestInteractiveItemBlockLoading
        v-if="item === '' || item === 'BlockLoading'"
        class="mt-5"
      />
      <TestInteractiveItemDialog
        v-if="item === '' || item === 'Dialog'"
        class="mt-5"
      />
      <TestInteractiveItemModal
        v-if="item === '' || item === 'Modal'"
        class="mt-5"
      />
      <TestInteractiveItemToast
        v-if="item === '' || item === 'Toast'"
        class="mt-5"
      />
      <TestInteractiveItemWindowLoader
        v-if="item === '' || item === 'WindowLoader'"
        class="mt-5"
      />
    </div>
  </div>
